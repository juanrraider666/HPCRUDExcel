...
use AppBundle\Report\Http\HttpResponseTrait;
use PHPExcel;
...
class ExcelExport
{
    ...
    public function createHeaderStyle($headers, $name)
    {
        ...
        $logo =  realpath($this->properties['path'] . '/../web/images/logo_hp.jpg'); // Provide path to your logo file
        ...
        $this->activeWorksheet->getStyle('C2')->applyFromArray(array('font' => array('bold' => true, 'color' => array('rgb' => '0BACED'))));
        ...
        $this->activeWorksheet->setCellValue('C4', 'Date ' . date("m-d-Y h:i:sa"));
        //SHEET DATA
        $this->firstRow = 6;
        $this->firstCol = 2;

...
namespace AppBundle\Report\Registration;

use AppBundle\Report\ExcelExport;
use AppBundle\Report\ExportReportInterface;
use AppBundle\Report\Http\HttpResponseTrait;
use AppBundle\Report\NotFoundException;

/**
 * @author Manuel Aguirre <programador.manuel@gmail.com>
 */
class RegistrationPerformanceLiveReport implements ExportReportInterface
{
    /**
     * @var ExcelExport
     */
